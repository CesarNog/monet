...
<body>
	...
	<div id="show-prospect"
		...
		<ol class="property-list prospect">
				...
				<g:if test="${prospectInstance?.contact}">
				<li class="fieldcontain">
					<span id="contact-label" class="property-label"><g:message code="prospect.contact.label" default="Contact" /></span>
					
						<span class="property-value" aria-labelledby="contact-label"><g:link controller="contact" action="show" id="${prospectInstance?.contact?.id}">${prospectInstance?.contact?.encodeAsHTML()}</g:link></span>
