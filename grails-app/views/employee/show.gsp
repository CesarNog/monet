...
<title><g:message code="employee.show.title.label" args="[entityName]" /></title>
</head>
<body>
	...
	<div class="nav" role="navigation">
		<ul>
			...
			<li><g:link class="list" action="list">
					<g:message code="employee.create.list.label" />
				</g:link></li>
			<li><g:link class="create" action="create">
					<g:message code="employee.create.label" />
				</g:link></li>
		</ul>
	</div>
	<div id="show-employee"
		...
		<h1>
			<g:message code="employee.show.title.label" args="[employeeInstance?.name]" />
		</h1>
