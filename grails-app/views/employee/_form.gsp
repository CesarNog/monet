...
$(document).ready(function() {
    ...
    $("#btn_dialog").bind("click", function(data) {
        $.ajax({
            url:'/Cadastro-Empresa/functions/createAjax',
...
<div class="fieldcontain ${hasErrors(bean: employeeInstance, field: 'functions', 'error')} required">
	...
	<%--<g:select id="functions" name="functions.id" from="${com.cpqd.monet.functions.Functions.list()}" optionValue="description" required="" class="many-to-one"/>
--%>
    <input value="Funções" type="button" id="btn_dialog"></input>
</div>
