...
<body>
	<a href="#edit-functions" class="skip" tabindex="-1"><g:message
	...
	<div id="edit-functions"
		...
		<g:hasErrors bean="${functionsInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${functionsInstance}" var="error">
					<li
		...
		<g:form method="post"
			...
			<g:hiddenField name="version" value="${functionsInstance?.version}" />
			<fieldset class="form">
