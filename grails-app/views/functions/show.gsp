...
<title><g:message code="functions.show.title.label" args="[entityName]" /></title>
</head>
<body>
	...
	<div class="nav" role="navigation">
		<ul>
			...
			<li><g:link class="list" action="list">
					<g:message code="functions.create.list.label"/>
				</g:link></li>
			<li><g:link class="create" action="create">
					<g:message code="functions.create.title.label"/>
				</g:link></li>
		</ul>
	</div>
	<div id="show-functions"
		...
		<h1>
			<g:message code="functions.show.title.label" args="[functionsInstance?.description]" />
		</h1>
		...
		<ol class="property-list functions">
				...
				<li class="fieldcontain">
					<span id="startDate-label" class="property-label"><g:message code="functions.startDate.label" default="Start Date" /></span>
						...
						<span class="property-value" aria-labelledby="startDate-label"><g:formatDate date="${functionsInstance?.startDate}" type="date"/></span>
				...
				<li class="fieldcontain">
					<span id="endDate-label" class="property-label"><g:message code="functions.endDate.label" default="End Date" /></span>
						...
						<span class="property-value" aria-labelledby="endDate-label"><g:formatDate date="${functionsInstance?.endDate}" type="date"/></span>
